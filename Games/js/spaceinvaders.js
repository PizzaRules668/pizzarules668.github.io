...
Game.prototype.touchstart = function(s) {
    if(this.currentState() && this.currentState().keyDown) {
        this.currentState().keyDown(this, KEY_UP);
    }    
};
...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("Press Up Arrow or touch to start.", game.width / 2, game.height/2);
    ctx.fillText("Use the Left and Right Arrow Keys to move, use the Up Arrow to Shot ", game.width / 2, game.height/1.9); 
};
